package com.yhbc.base.common.view.tablayout;
...
import com.yhbc.base.common.view.tablayout.listener.CustomTabEntity;
import com.yhbc.base.common.view.tablayout.listener.OnTabSelectListener;
import com.yhbc.base.common.view.tablayout.utils.FragmentChangeManager;
import com.yhbc.base.common.view.tablayout.utils.UnreadMsgUtils;
...
//    private int mIndicatorGravity;
    ...
    private int mMsgUnSelectColor;
    private int mTextUnselectColor;
    private int mTextBold;
    private int mMsgColor;
    private boolean mTextAllCaps;
    private float mTextMarginBottom = 0f;
    //icon属性
    ...
    private int mHeight;
    private int mDivderWidthPostion = 0;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mBackgroundNormal = ta.getInt(R.styleable.CommonTabLayout_tl_background_normal, Color.parseColor("#00000000"));
        mBackgroundSelect = ta.getInt(R.styleable.CommonTabLayout_tl_background_select, Color.parseColor("#FFFFFF"));

        mIndicatorColor = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color, Color.parseColor("#ffffff"));
        mIndicatorHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_height, dp2px(2));
        mIndicatorWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_width, dp2px(-1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_corner_radius, dp2px(0));
...
//        mIndicatorGravity = ta.getInt(R.styleable.CommonTabLayout_tl_indicator_gravity, Gravity.BOTTOM);
        ...
        mMsgUnSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_mMsgUnSelectColor, mTextSelectColor);
//        mMsgUnSelectColor = getResources().getColor(R.color.color_ac9d88);
        mTextUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
        mMsgColor = ta.getColor(R.styleable.CommonTabLayout_tl_msgColor, Color.parseColor("#A77341"));
        ...
        mTextMarginBottom = ta.getDimension(R.styleable.CommonTabLayout_tl_textMarginBottom, 0f);
        ...
        mTabDivider = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_divider,0);
        ta.recycle();
    }
    ...
    public void notifyDataSetChanged() {
        setBackgroundColor(mBackgroundNormal);
    ...
    private void addTab(final int position, View tabView) {
        if(mTextMarginBottom>0){
            LinearLayout tap = (LinearLayout) tabView.findViewById(R.id.ll_tap);
            tap.setPadding(tap.getPaddingLeft(),tap.getPaddingTop(),tap.getPaddingRight(), (int) mTextMarginBottom);
        }
        ...
        lp_tab.setMarginEnd((int)mTabDivider);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            msgView.setBackgroundColor(i == mCurrentTab ? mMsgColor:mMsgUnSelectColor );
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            tabView.setBackgroundColor(isSelect ? mBackgroundSelect : Color.TRANSPARENT);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDividerWidth > 0) {
            ...
            for (int i = 0; i < mTabCount - 1; i++) {
                if (mDivderWidthPostion == i ||(mDivderWidthPostion >= 1 && mDivderWidthPostion - 1 == i) ){
                } else {
...
//    }
    ...
    public void setDivderWidthShow(float dividerWidth, int postion){
        this.mDivderWidthPostion = postion;
        this.mDividerWidth = dp2px(dividerWidth);
        invalidate();
    }
    ...
    public void showMsg(int position, int num) {
        ...
        if (tipView != null) {
            ...
            if (!mIconVisible) {
                setMsgMargin(position,  dp2px(2), dp2px(2));
            } else {
    ...
    public void showMsg2(int position, int num) {
        ...
        MsgView tipView = (MsgView) tabView.findViewById(R.id.rtv_msg_tip);
        if (tipView != null) {
            UnreadMsgUtils.show2(tipView, num);
            if (mInitSetMap.get(position) != null && mInitSetMap.get(position)) {
                return;
            }
