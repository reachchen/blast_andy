...
package com.yhbc.base.common.view.wheelview;
...
public class WheelView extends View {
	 ...
	 * @param res 背景resid
     */
	public void setShadowAndBg(int color, int res) {
		this.backgroundResId = res;
		SHADOWS_COLORS[0] = color | 0xFF000000;
		SHADOWS_COLORS[1] = color | 0x66000000;
		SHADOWS_COLORS[2] = color | 0x33000000;
	...
	public void setTextSize(int centerPx, int otherPx) {
		this.centerPx = centerPx;
		this.otherPx = otherPx;
	}

	/**
	 * 中间背景resid
	 *
	 * @param centerRes resource id
	 */
	public void setCenterRes(int centerRes) {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(otherPx == 0 ? TEXT_SIZE : otherPx);
		}

		if (valuePaint == null) {
			valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
			// valuePaint.density = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(centerPx == 0 ? TEXT_SIZE : centerPx);
//			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(centerRes == 0 ? R.drawable.wheel_val : centerRes);
		}
		...
		setBackgroundResource(backgroundResId == 0 ? R.drawable.wheel_bg : backgroundResId);
	}
	...
	private void drawShadows(Canvas canvas) {
		...
		int one = height / visibleItems;
		int top = (height - one) / 2;
		topShadow.setBounds(0, 0, getWidth(), top);
		topShadow.draw(canvas);

		bottomShadow.setBounds(0, top + one,
				getWidth(), getHeight());
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(textColor == 0 ? VALUE_TEXT_COLOR : textColor);
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(textColor == 0 ? ITEMS_TEXT_COLOR : textColor);
