...
public class CustomPopupWindow extends PopupWindow {
    ...
    private void initLayout() {
        ...
        setHeight(isHeight ? ViewGroup.LayoutParams.WRAP_CONTENT : ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    public void show() {//默认显示到中间
        if (mParentView == null) {
            showAtLocation(mContentView, Gravity.CENTER | Gravity.BOTTOM, 0, 0);
        } else {
            showAtLocation(mParentView, Gravity.CENTER | Gravity.BOTTOM, 0, 0);
        }
    }
    ...
    public static final class Builder {
        ...
        public Builder setWidth(boolean isWrap) {
            this.isWrap = isWrap;
            return this;
        }

        public Builder setHeight(boolean isHeight) {
